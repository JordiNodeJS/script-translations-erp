export default {
  ...
  subtitle_orders_with_payments_not_do_it:
    "List of orders with pending payment",
  ...
  end_date_must_be_after_start_date:
    "The end date has to be longer than the initial date.",
  ...
  description_clip_functional:
    "Has the customer purchased the FIRST additional clip for XXX?",
  design: "Design",
  ...
  comment_payment:
    "If there are any details not covered in the previous questions, or the cliente have chosen more accessories, please add them in the comments below\n\t- Functional clip £25\n\t- Design clip £20\n\t- Temple £20",
  ...
  appointments_filter_info:
    "You can filter the appointments by state and create time blocks",
  ...
  instructions3:
    "GO TO TERMINAL SETTINGS, FOR THIS YOU MUST SLIDE YOUR FINGER FROM THE LEFT EDGE OF THE SCREEN TO THE RIGHT, AT WHICH POINT A PANEL WILL OPEN.",
  instructions4:
    'NEXT, YOU MUST SELECT SETTINGS AND ENTER THE FOLLOWING PIN: 07139. DIFFERENT OPTIONS WILL APPEAR. SELECT "NETWORK" AND CONNECT TO YOUR WI-FI.',
  instructions5:
    'ONCE YOU HAVE THE WI-FI CONNECTED, RETURN TO THE PREVIOUS MENU AND SELECT THE OPTION "GENERATE A PAIRING CODE". A KEY WILL BE GENERATED THAT YOU MUST ENTER IN THE APPLICATION.',
  instructions6:
    'THE PLACE TO ENTER THIS CODE IS IN THE FOLLOWING WINDOW OF THE FORM "ADD NEW DEVICE". ONCE ENTERED AND CONNECTED CORRECTLY IT WILL APPEAR IN "AVAILABLE TPV\'S".',
  instructions7: "SELECT THE TPV AND MAKE THE PAYMENT.",
  instructions8:
    "IN THIS WAY THE TPV IS PAIRED AND ASSOCIATED WITH YOUR OPTIC. IN THE SUCCESSIVE OPERATIONS YOU CARRY OUT, YOU WILL ONLY NEED TO CONNECT IT TO YOUR WIFI NETWORK.",
  ...
  m_title_selection13:
    "Only configured accessories for this pack are shown below.",
  ...
  m_title_selection28:
    "Once you confirm this order, it cannot be modified. The order will be created and processed immediately.",
  ...
  m_new_payment_dojo_6:
    "We are having trouble processing the payment response.",
  ...
  tour_c_subtitle_3:
    "This section is exclusively for registering sales that do not belong to ",
  tour_c_subtitle_3_1: "FLIPO",
  tour_c_subtitle_3_2:
    ". Please use this area for sales unrelated to our standard products.",
  ...
  product_cards_accessories_subtitle_2:
    "You can click on the Packs card to get more details.",
  ...
  product_list_actions:
    "You will be able to: Remove, Add, and view the quantity of each.",
  ...
  product_configuration_panel_strong:
    "Click on the panel to discover more details and options.",
  ...
  add_clip_modal_description:
    "You can add an additional clip to your order for",
  ...
  "0300014 + 0500015":
    "Original Clip (Nilo) Fuchsia Reflective Polarized Solar",
  ...
  "0300060 + 0500040":
    "Model A Clip (Dante) Fuchsia Reflective Polarized Solar",
  ...
  "0300083 + 0500055":
    "Model D Clip (Siena) Fuchsia Reflective Polarized Solar",
