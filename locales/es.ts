const es = {
  ...
  description_clip_functional:
    "¿El cliente ha comprado el PRIMER clip adicional por XXX?",
  design: "Diseño",
  dont_send_btn: "No enviar",
  eliteProgressives: "Progresivas Élite",
  error_num_min:
    "Introduce un numero mayor o igual al calculado a base de los productos introducidos",
  ...
  title_final_form:
    "Ya has terminado el formulario de montura y accesorios ! \n\n ! Recuerda que, en caso de que FLiPO realice las lentes, aún queda pendiente el formulario de lentes.",
  ...
  appointments_filter_info:
    "Puedes filtrar las citas por estado y crear bloqueos de tiempo para bloquear",
  ...
  title_modal_remember_fill_form:
    "Recuerda rellenar los formularios que tienes pendientes!",
  today: "Hoy",
  total_appointments: "Citas Totales",
  unsold_appointment_panel_toggle: "Comentarios",
  unsold_appointment_panel_toggle_error:
    "Solo puedes usar esta función si la Cita no resulto en venta.",
  unsold_appointment_panel_toggle_info:
    "Rellena información sobre esta cita que no resultó en venta.",
  ...
  online_or_offline_pin_required:
    "La tarjeta fue rechazada porque requiere un PIN",
  ...
  // CardOrderItemsContent coic
  coic_title_1: "Por favor agregue los productos a ser solicitados:",
  coic_title_2:
    "Aquí podrá agregar los productos para completar su orden a FLiPO",
  coic_description_1: "Los packs de siempre, curioso, Full, Flipante",
  coic_description_2:
    "Compra accesorios de forma individual, no asociados a Packs",
  ...
  m_title_selection13:
    "A continuación sólo se muestran los accesorios configurados para este pack.",
  ...
  m_title_completed_selection20:
    "El pack está completamente configurado y listo.",
  m_title_completed_selection21:
    "El pack aún no está completamente configurado.",
  ...
  m_title_selection28:
    "Una vez que confirme este pedido, no podrá agregar nuevos productos ni modificar las cantidades. Sin embargo, podrá ajustar las configuraciones de los productos ya incluidos en el pedido. El pedido se creará y procesará inmediatamente",
  ...
  REMINDER_MESSAGE:
    "Necesitamos que completes el formulario de graduación de lentes para preparar tu pedido. ¿Te gustaría hacerlo ahora?",
  YES_BUTTON: "SÍ",
  NO_BUTTON: "NO",
  ...
  m_new_payment_dojo_6:
    "Tenemos problemas para procesar la respuesta del pago.",
  m_new_payment_dojo_7:
    "Error de comunicación con la terminal. Por favor, verifica si la transacción se completó. POR FAVOR CONTACTA CON TU GESTOR FLIPO",
  m_new_payment_dojo_8: "CONTINUAR",
  m_new_payment_dojo_9: "TPV no disponible",
  m_new_payment_dojo_10:
    "Intenta de nuevo en 10 segundos o revisa la pantalla y cables del terminal. Si el problema sigue, contacta soporte.",
  ...
  modal_additional_accessory_question:
    "¿Desea agregar un accesorio adicional al pack por 10 euros?",
  modal_additional_accessory_description:
    "Puede mejorar su pack añadiendo un accesorio adicional por solo 10 euros.",
  ...
  tour_c_subtitle_1:
    "Este encabezado te muestra cómo va tu pedido. Tiene un total de tres pasos que debes completar",

  tour_c_title_2: "Lista de Packs",
  tour_c_subtitle_2:
    "Esta sección muestra una lista de tarjetas de productos en la categoría",
  tour_c_subtitle_2_2: "Packs",
  tour_c_subtitle_2_3:
    ". Puedes hacer clic en la tarjeta de Packs para obtener más detalles.",

  tour_c_title_3: `Venta 'NOT FLIPO'`,
  tour_c_subtitle_3:
    "Esta sección está destinada exclusivamente para registrar ventas que no pertenezcan a ",
  tour_c_subtitle_3_1: "FLIPO",
  tour_c_subtitle_3_2:
    ". Por favor, utilice esta área para ventas no relacionadas con nuestros productos estándares.",
  ...
  product_list_subtitle_1:
    "Esta tarjeta muestra una lista de productos donde los artículos que elijas de las categorías ",
  ...
  product_list_actions:
    "Podrás: Eliminar, Añadir y ver la cantidad de cada uno.",

  continue_button_title: 'Botón "Continuar"',
  continue_button_subtitle:
    'El botón "Continuar" se activará una vez que hayas agregado algo a tu orden. Puedes usar este botón para avanzar al siguiente paso de tu pedido y continuar con el proceso de compra.',

  order_summary_title: "Resumen de tu orden",
  order_summary_subtitle_1:
    "Esta tarjeta muestra un resumen de tu orden. Al lado de cada producto, hay una ",
  order_summary_label: "etiqueta",
  order_summary_subtitle_2:
    ' que indica el estado del producto: "obligatorio", "sin completar" o "completado". Esto te ayuda a identificar fácilmente qué elementos necesitas completar antes de finalizar tu pedido.',

  customization_section_title: "Sección de Personalización",
  customization_section_subtitle_1:
    "Esta sección te permite terminar de personalizar todo tu producto, incluyendo: ",
  ...
  customization_section_subtitle_2:
    '. Cada opción muestra su estado de "obligatorio", "sin completar" o "completado", para que puedas seguir el progreso de tu personalización.',

  client_info_card_title: "Tarjeta de Información del Cliente",
  client_info_card_subtitle_1:
    "Esta tarjeta te proporciona información sobre el cliente asociado a la cita. Incluye detalles como la fecha de la cita, el tipo de cliente (ya sea ",
  client_info_card_highlight_1: "FLIPO",
  client_info_card_highlight_2: "OPTIC",
  client_info_card_subtitle_2:
    "), y las promociones que aplican para este cliente. Esto te ayuda a tener una visión clara de las preferencias y beneficios del cliente para su cita.",

  product_configuration_card_title: "Tarjeta de Configuración del Producto",
  product_configuration_card_subtitle_1:
    "Esta tarjeta muestra todas las opciones requeridas para configurar el producto, las cuales pueden variar según los distintos tipos. Puedes seleccionar diferentes características y accesorios para personalizar tu producto a tus necesidades específicas.",
  product_configuration_panel_title: "Panel de Configuración de Accesorios",
  product_configuration_panel_subtitle_1:
    "Este panel te permite ajustar las configuraciones de los accesorios seleccionados de manera personalizada. Aquí podrás visualizar de forma clara las opciones disponibles y establecer la cantidad máxima que puedes añadir a tu selección, asegurándote de obtener la configuración exacta que necesitas.",
  product_configuration_panel_strong:
    "Haz clic en el panel para descubrir más detalles y opciones.",

  product_personalize_panel_title: "Panel de Configuración de Accesorios",
  product_personalize_panel_subtitle_1:
    "Este panel ofrece dos funciones clave:",
  product_personalize_function_1:
    '1. Botones de "+" y "-" que te permiten aumentar o reducir la cantidad del mismo producto.',
  product_personalize_function_2:
    '2. Un botón de "Personalizar" que te permite modificar el producto seleccionado de acuerdo a tus preferencias.',
  ...
  payment_issue:
    "Lamentamos que haya tenido problemas al pagar con su tarjeta. A continuación, le ofrecemos una serie de recomendaciones para evitar que se repita esta situación:",
  card_active:
    "Verifique que su tarjeta esté activa y que no haya caducado. Puede consultar el estado de su tarjeta en su banco o en la aplicación móvil de su entidad financiera.",
  check_details:
    "Compruebe que haya introducido correctamente los datos de su tarjeta, como el número, la fecha de caducidad y el código de seguridad. Asegúrese de que no haya espacios ni caracteres especiales entre los dígitos.",
  check_balance:
    "Asegúrese de que tenga saldo suficiente en su cuenta para realizar el pago. Si su tarjeta tiene un límite de crédito, compruebe que no lo haya superado.",
  sms_verification:
    "Si su tarjeta tiene habilitada la opción de pago seguro o de verificación por SMS, asegúrese de que tenga cobertura y de que reciba el código de confirmación en su teléfono móvil. Introduzca el código en el plazo indicado y no lo comparta con nadie.",
  blocked_card:
    "Si ha realizado varios intentos fallidos de pago, es posible que su tarjeta haya sido bloqueada temporalmente por motivos de seguridad. En ese caso, póngase en contacto con su banco para desbloquearla y poder volver a utilizarla.",
  alternate_payment:
    "Si el problema persiste, puede intentar pagar con otra tarjeta o con otro método de pago disponible en nuestra página web. También puede contactar con nuestro servicio de atención al cliente para que le ayudemos a resolver cualquier duda o incidencia.",
  ...
  add_clip_modal_add_button:
    'Haz clic en "Agregar a la Orden" para confirmarlo.',
  ...
  //new product list
  "0400001": "Varillas Carey",
  "0400002": "Varillas Azul Navy",
  "0400003": "Varillas Rojo Rioja",
  "0400004": "Varillas Amarillo Limón",
  "0400005": "Varillas Rosa Pálido",
  "0400006": "Varillas Verde Pistacho",
  "0400007": "Varillas Lila Very Peri",
  "0400008": "Varillas Iced Coffee",
  "0400009": "Varillas Verde Olive",
  "0400010": "Varillas Valentina",
  "0400011": "Varillas Red Sunset",
  "0400012": "Varillas White Polar",
  "0400013": "Varillas Green Forest",
  "0400014": "Varillas Caoba",
  "0400015": "Varillas Zebra",
  "0400016": "Varillas Hawai",
  "0400017": "Varillas Azul Mármol",
  "0400018": "Varillas Puzzle",
  "0400019": "Varillas Brunch Vibes",
  "0400020": "Varillas Sailor",
  "0400021": "Varillas Kenia",
  "0400022": "Varillas Highlands",
  "0400023": "Varillas Negras",
  "0400024": "Varillas Chocolate",
  "0400025": "Varillas Red Passion",
  "0400026": "Varillas Valparaiso",
  "0400027": "Varillas Black Flowers",

  "0200001": "Clip Original (Nilo) Espejo Solar Azul",
  "0200002": "Clip Original (Nilo) Solar Negro",
  "0200003": "Clip Original (Nilo) Conducción Nocturna",
  "0200004": "Clip Original (Nilo) Espejo Naranja",
  "0200005": "Clip Original (Nilo) Proteción Pantalla",
  "0200006": "Clip Model C (Ivy) Espejo Azul",
  "0200007": "Clip Model C (Ivy) Solar Negro",
  "0200008": "Clip Model C (Ivy) Conducción Nocturna",
  "0200009": "Clip Model C (Ivy) Espejo Naranja",
  "0200010": "Clip Model C (Ivy) Proteción Pantalla",
  "0200011": "Clip Model A (Dante) Espejo Azul",
  "0200012": "Clip Model A (Dante) Solar Negro",
  "0200013": "Clip Model A (Dante) Conducción Nocturna",
  "0200014": "Clip Model A (Dante) Espejo Naranja",
  "0200015": "Clip Model A (Dante) Proteción Pantalla",
  "0200016": "Clip Model D (Siena) Espejo Azul",
  "0200017": "Clip Model D (Siena) Solar Negro",
  "0200018": "Clip Model D (Siena) Conducción Nocturna",
  "0200019": "Clip Model D (Siena) Espejo Naranja",
  "0200020": "Clip Model D (Siena) Proteción Pantalla",
  ...
  "0300014 + 0500015":
    "Clip Original (Nilo) Solar Fucsia Reflective polarizado",
  "0300014 + 0500016":
    "Clip Original (Nilo) Solar Morado Reflective Polarizado",
  ...
  "0300060 + 0500040":
    "Clip Model A (Dante) Solar Fucsia Reflective polarizado",
  "0300060 + 0500041":
    "Clip Model A (Dante) Solar Morado Reflective Polarizado",
  ...
  "0300083 + 0500055":
    "Clip Model D (Siena) Solar Fucsia Reflective polarizado",
  "0300083 + 0500056":
    "Clip Model D (Siena) Solar Morado Reflective Polarizado",
  ...
  "0300002": "Clip Original (Nilo) Azul Navy",
  "0300003": "Clip Original (Nilo) Rioja",
  "0300004": "Clip Original (Nilo) Amarillo Limón",
  "0300005": "Clip Original (Nilo) Rosa Pálido",
  "0300006": "Clip Original (Nilo) Verde Pistacho",
  "0300007": "Clip Original (Nilo) Lila Very Peri",
  ...
  "0300014": "Clip Original (Nilo) Base Negra",
  "0300015": "Clip Original (Nilo) Caoba",
  "0300016": "Clip Original (Nilo) Zebra",
  "0300017": "Clip Original (Nilo) Hawai",
  "0300018": "Clip Original (Nilo) Azul Mármol",
  "0300019": "Clip Original (Nilo) Puzzle",
  "0300020": "Clip Original (Nilo) Brunch Vibes",
  "0300021": "Clip Original (Nilo) Sailor",
  "0300022": "Clip Original (Nilo) Kenia",
  "0300023": "Clip Original (Nilo) Highlands",
  "0300024": "Clip Model C (Ivy) Carey",
  "0300025": "Clip Model C (Ivy) Azul Navy",
  "0300026": "Clip Model C (Ivy) Rojo Rioja",
  "0300027": "Clip Model C (Ivy) Amarillo Limón",
  "0300028": "Clip Model C (Ivy) Rosa Pálido",
  "0300029": "Clip Model C (Ivy) Verde Pistacho",
  "0300030": "Clip Model C (Ivy) Lila Very Peri",
  ...
  "0300037": "Clip Model C (Ivy) Base Negra",
  "0300038": "Clip Model C (Ivy) Caoba",
  "0300039": "Clip Model C (Ivy) Zebra",
  "0300040": "Clip Model C (Ivy) Hawai",
  "0300041": "Clip Model C (Ivy) Azul Mármol",
  "0300042": "Clip Model C (Ivy) Puzzle",
  "0300043": "Clip Model C (Ivy) Brunch Vibes",
  "0300044": "Clip Model C (Ivy) Sailor",
  "0300045": "Clip Model C (Ivy) Kenia",
  "0300046": "Clip Model C (Ivy) Highlands",
  "0300047": "Clip Model A (Dante) Carey",
  "0300048": "Clip Model A (Dante) Azul Navy",
  "0300049": "Clip Model A (Dante) Rojo Rioja",
  "0300050": "Clip Model A (Dante) Amarillo Limón",
  "0300051": "Clip Model A (Dante) Rosa Pálido",
  "0300052": "Clip Model A (Dante) Verde Pistacho",
  "0300053": "Clip Model A (Dante) Lila Very Peri",
  ...
  "0300060": "Clip Model A (Dante) Base Negra",
  "0300061": "Clip Model A (Dante) Caoba",
  "0300062": "Clip Model A (Dante) Zebra",
  "0300063": "Clip Model A (Dante) Hawai",
  "0300064": "Clip Model A (Dante) Azul Mármol",
  "0300065": "Clip Model A (Dante) Puzzle",
  "0300066": "Clip Model A (Dante) Brunch Vibes",
  "0300067": "Clip Model A (Dante) Sailor",
  "0300068": "Clip Model A (Dante) Kenia",
  "0300069": "Clip Model A (Dante) Highlands",
  "0300070": "Clip Model D (Siena) Carey",
  "0300071": "Clip Model D (Siena) Azul Navy",
  "0300072": "Clip Model D (Siena) Rojo Rioja",
  "0300073": "Clip Model D (Siena) Amarillo Limón",
  "0300074": "Clip Model D (Siena) Rosa Pálido",
  "0300075": "Clip Model D (Siena) Verde Pistacho",
  "0300076": "Clip Model D (Siena) Lila Very Peri",
  ...
  "0300083": "Clip Model D (Siena) Base Negra",
  "0300084": "Clip Model D (Siena) Caoba",
  "0300085": "Clip Model D (Siena) Zebra",
  "0300086": "Clip Model D (Siena) Hawai",
  "0300087": "Clip Model D (Siena) Azul Mármol",
  "0300088": "Clip Model D (Siena) Puzzle",
  "0300089": "Clip Model D (Siena) Brunch Vibes",
  "0300090": "Clip Model D (Siena) Sailor",
  "0300091": "Clip Model D (Siena) Kenia",
  ...
  //new frames
  "0100001": "Montura Original (Nilo) Negra",
  "0100002": "Montura Original (Nilo) Light",
  "0100003": "Montura Model C (Ivy) Negra",
  "0100004": "Montura Model C (Ivy) Light",
  "0100005": "Montura Model A (Dante) Negro",
  "0100006": "Montura Model A (Dante) Light",
  "0100007": "Montura Model D (Siena) Negro",
  "0100008": "Montura Model D (Siena) Light",
};
export default es;
